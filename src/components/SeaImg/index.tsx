...
import { WhaleData } from "../../data/WhaleImg";
        ...
        <div className={`position-relative ${styles.item}`}>
          <div className={`${styles.thumb_oceanImg}`}>
            ...
            <div className={`${styles.edit_SeaImg}`}>
              <div
                className={`${styles.source_SeaImg}  animate__animated  animate__backInLeft`}
              >
  ...
  return (
    <section className={styles.box_OceanImg}>
      <div className={styles.banner_sealife}>
        <img
          src="https://cdn.pixabay.com/photo/2017/08/04/19/54/light-bulb-2581192_1280.jpg"
          alt=""
        />
        <p className={styles.slogan}>𝓟𝓻𝓸𝓽𝓮𝓬𝓽 𝓽𝓱𝓮 𝓸𝓬𝓮𝓪𝓷, 𝓹𝓻𝓸𝓽𝓮𝓬𝓽 𝓶𝓪𝓻𝓲𝓷𝓮 𝓵𝓲𝓯𝓮</p>
        <div className={styles.search_oceanImg}>
          <form action="#">
            <input
              type="text"
              placeholder="Search Ocean images..."
